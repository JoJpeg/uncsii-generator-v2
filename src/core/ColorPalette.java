    ...
    public int[] findDominantColors(int[] blockPixels) {
        ...
        for (int pixel : blockPixels) {
            ...
            if (alpha == 0) {
                ...
                // Wenn der Pixel schwarz oder fast schwarz ist und opak, dann verwende den Index für opakes Schwarz (1)
        ...
        // Priorisiere nicht-transparente Farben, wenn ein signifikanter Teil des Blocks nicht transparent ist
        boolean hasSignificantContent = totalNonTransparentPixels > blockPixels.length * 0.2; // Mindestens 20% nicht transparent
        ...
        // Wenn nicht genug nicht-transparente Pixel oder keine dominanten Farben gefunden wurden, alle Indizes berücksichtigen

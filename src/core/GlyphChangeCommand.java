...
public class GlyphChangeCommand implements Command {
    ...
    public GlyphChangeCommand(ProcessingCore processingCore, int gridX, int gridY, ResultGlyph newGlyph) {
        ...
        this.gridX = gridX;
        this.gridY = gridY;
        this.newGlyph = new ResultGlyph(newGlyph.codePoint, newGlyph.fgIndex, newGlyph.bgIndex, newGlyph.alpha);
    ...
    public void execute() {
        if (processingCore.resultGrid != null &&
            ...
            processingCore.resultGrid[gridY][gridX] = new ResultGlyph(
                    newGlyph.codePoint, newGlyph.fgIndex, newGlyph.bgIndex, newGlyph.alpha);
    ...
    public void undo() {
        ...
        if (processingCore.resultGrid != null &&
            ...
            processingCore.resultGrid[gridY][gridX] = new ResultGlyph(
                    oldGlyph.codePoint, oldGlyph.fgIndex, oldGlyph.bgIndex, oldGlyph.alpha);
